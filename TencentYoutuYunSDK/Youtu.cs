...
namespace Tencent.YoutuYun.SDK
{
    public class Youtu
    {
        // 30 days
        ...
        public static string newperson(string image_path, string person_id, string person_name, List<string> group_ids, string person_tag)
        {
            ...
            pars = string.Format(pars, Conf.Instance().APPID, Utility.ImgBase64(image_path), JsonHelper<string[]>.ToJson(group_ids.ToArray()), person_id, person_name, person_tag);
            postData.Append("{");
            postData.Append(pars);
            postData.Append("}");
            string result = Http.HttpPost(methodName, postData.ToString(), Auth.appSign(expired, Conf.Instance().USER_ID));
        ...
        public static string newpersonurl(string url, string person_id, string person_name, List<string> group_ids, string person_tag)
        {
            ...
            pars = string.Format(pars, Conf.Instance().APPID, url, JsonHelper<string[]>.ToJson(group_ids.ToArray()), person_id, person_name, person_tag);
            postData.Append("{");
            postData.Append(pars);
            postData.Append("}");
            string result = Http.HttpPost(methodName, postData.ToString(), Auth.appSign(expired, Conf.Instance().USER_ID));
        ...
        public static string addface(string person_id, List<string> image_path_arr, string facetag = "")
        {
            ...
            pars = string.Format(pars, Conf.Instance().APPID, JsonHelper<string[]>.ToJson(faceImgBase64List.ToArray()), person_id, facetag);
        ...
        public static string addfaceurl(string person_id, List<string> url_arr, string facetag = "")
        {
            ...
            pars = string.Format(pars, Conf.Instance().APPID, JsonHelper<string[]>.ToJson(url_arr.ToArray()), person_id, facetag);
        ...
        public static string delface(string person_id, List<string> face_ids)
        {
            ...
            pars = string.Format(pars, Conf.Instance().APPID, person_id, JsonHelper<string[]>.ToJson(face_ids.ToArray()));
            postData.Append("{");
            postData.Append(pars);
            postData.Append("}");
            string result = Http.HttpPost(methodName, postData.ToString(), Auth.appSign(expired, Conf.Instance().USER_ID));
